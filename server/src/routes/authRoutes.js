...
import { loginSchema, registerSchema, resetPasswordSchema } from "../validators/authValidators.js";
...
router
  ...
  .post("/resend-confirmation-email", validateRequestMiddleware(z.object({email: z.email()})), resendConfirmationEmail)
